 ...
 * Privacy: this requests phone location permission and sends approximate
 * coordinates (rounded to 2 decimals) to Open-Meteo for the weather lookup.
 *
...
function locationSuccess(pos) {
  ...
  // Round coordinates before sending them to avoid sharing exact location.
  var latitude = roundCoordinate(pos.coords.latitude);
  var longitude = roundCoordinate(pos.coords.longitude);

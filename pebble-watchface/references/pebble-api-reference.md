...
When using `navigator.geolocation`, disclose that the app requests phone location permission. Round coordinates or use a user-provided city before sending weather requests, and avoid logging or storing exact coordinates.
